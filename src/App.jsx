 ...
 const handleCheckbox=(e)=>{
  ...
  return (
    ...
    <Navbar/>
     ...
     <h1 className='font-bold text-center text-3xl'>iTask-Manage your at one place</h1>
      <div className="addtodo my-5 flex flex-col gap-4">
        <h2 className='text-2xl font-bold'>Add a Todo</h2>
        <div className="flex">
        <input onChange={handleChange} value={todo} type='text' className='w-full rounded-lg px-5 py-1'/>
        <button  onClick={handleAdd} disabled={todo.length<=  3} className='bg-violet-800 hover:bg-violet-950 p-4 py-2 font-bold text-white  rounded-full mx-2 '>Save</button>
        </div>
      </div>
      <div>
